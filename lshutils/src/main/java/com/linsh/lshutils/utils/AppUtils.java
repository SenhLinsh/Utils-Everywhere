...
public class AppUtils {
    ...
    public static boolean isServiceRunning(String serviceClassName) {
        ActivityManager activityManager = (ActivityManager) ApplicationUtils.getContext().getSystemService(Context.ACTIVITY_SERVICE);
    ...
    public static String getPackageName() {
        return ApplicationUtils.getPackageName();
    }
    ...
    public String getAppName() {
        PackageManager pm = ApplicationUtils.getContext().getPackageManager();
        try {
    ...
    public static boolean isAppInstalled(String packageName) {
        try {
            ApplicationUtils.getContext().getPackageManager().getPackageInfo(packageName, 0);
            return true;
        } catch (PackageManager.NameNotFoundException e) {
            return false;
        }
    ...
    public static boolean checkAndStartInstalledApp(Activity activity, String packageName) {
        if (isAppInstalled(packageName)) {
            Intent intent = ApplicationUtils.getContext().getPackageManager().getLaunchIntentForPackage(packageName);
