...
public class ScreenUtils {
    ...
    public static DisplayMetrics getScreenSize() {
        WindowManager wm = (WindowManager) ApplicationUtils.getContext().getSystemService(Context.WINDOW_SERVICE);
    ...
    public static int getScreenShortSize() {
        DisplayMetrics outMetrics = ApplicationUtils.getContext().getResources().getDisplayMetrics();
